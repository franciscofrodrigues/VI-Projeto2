...
function updateRadarChart(regionName) {
  ...
  function showTooltip(d, i) {
    ...
    // Posiciona o tooltip diretamente sobre o círculo
    tooltip
      .html(valores[i])
      .style('position', 'absolute')
      .style('left', (xPosition - 100) + 'px')  // Ajuste para centrar horizontalmente
      .style('top', (yPosition - 30) + 'px')   // Ajuste para posicionar acima do círculo
      .style('display', 'block');
  }
